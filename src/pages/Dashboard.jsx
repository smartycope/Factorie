...
export default function Dashboard() {
  ...
  function addExamples() {
    const ex1 = JSON.parse(
      `{"name":"What should I eat for dinner?","factors":{"names":["Taste","Cost","Healthiness","Time to Make","Leftovers"],"units":["0-10","$","0-10","minutes","portions"],"optimals":[10,0,10,0,5],"weights":[0.9,1,0.85,0.6,0.2],"mins":[0,0,0,null,0],"maxs":[10,null,10,null,null]},"options":["Taco Bell","Spaghetti","Tacos","Leftovers","Chicken noodle soup"],"answers":[[[8,8],[15,15],[6,6],[15,30],[1,1]],[[3,3],[5,6],[8,8],[20,20],[1,1]],[[10,10],[8,8],[9,9],[10,10],[1,1]],[[5,5],[1,1],[9,9],[5,5],[1,1]],[[9,9],[4,4],[10,10],[10,10],[5,5]]],"threshold":0,"factorPacks":["Choosing Dinner"]}`,
    );
